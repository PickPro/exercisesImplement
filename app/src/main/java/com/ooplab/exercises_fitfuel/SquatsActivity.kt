...
class SquatsActivity : AppCompatActivity() {
    ...
    var count = 0  // Keeps track of the number of reps
    var stage = "Up"  // Track squat stage: "Up" or "Down"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_squats) // Sets the layout for the activity using XML file 'activity_main'.
